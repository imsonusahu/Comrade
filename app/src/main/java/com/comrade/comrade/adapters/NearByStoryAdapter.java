...
public class NearByStoryAdapter extends RecyclerView.Adapter<NearByStoryAdapter.VH> {

    ArrayList<StoryProfileModel> arrayList;
    Context context;

    public NearByStoryAdapter(FragmentActivity activity, ArrayList<StoryProfileModel> myArraylist) {
    ...
    @Override
    public void onBindViewHolder(@NonNull NearByStoryAdapter.VH holder, int position) {
